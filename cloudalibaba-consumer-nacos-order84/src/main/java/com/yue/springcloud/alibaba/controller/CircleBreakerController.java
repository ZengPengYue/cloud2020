...
import com.yue.springcloud.alibaba.service.PaymentService;
...
//    @SentinelResource(value = "fallback", fallback = "handerFallback",blockHandler = "blockHandler") //同时配置fallback和blockHandler
    @SentinelResource(value = "fallback",
            fallback = "handerFallback",blockHandler = "blockHandler",
            exceptionsToIgnore = {IllegalArgumentException.class}) // exceptionsToIgnore 忽略部分异常
    ...
    public CommonResult handerFallback(@PathVariable Long id,Throwable e){
        ...
        return new CommonResult(444,"兜底异常handerFallback，exception内容:"+e.getMessage(),payment);
    }
    ...
    @GetMapping(value = "/consumer/paymenSQL/{id}")
